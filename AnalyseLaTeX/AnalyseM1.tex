...
\Dnote{Pour $O_n$ une suite d'ouverts, il est possible que $\bigcap_{n\geqslant 0}O_n$ ne soit pas ouvert puisque, par (contre) exemple
...
\Dnote{De même, pour $F_n$ un suite de fermé, il est possible que $\bigcup_{n\geqslant 0}F_n$ ne soit pas fermés, puisque, par (contre) exemple
...
\end{flalign*}
on va donc changer de $\delta$, on va prendre le $\tilde\delta$ définie à partir de $\nicefrac{\varepsilon}{b-a}$ et on a maintenant
...
\begin{Proof}
  ...
  \begin{align*}
    f_a(t)&\frac{1}{a\left(1-\nicefrac{t}{a}\right)}&=\frac{1}{a}\sum{k=0}^\infty\frac{t^k}{a^k}\\
    f_a(t)&\frac{1}{a\left(1-\nicefrac{t}{a}\right)}&=\sum{k=0}^\infty\frac{t^k}{a^{k+1}}
  \end{align*}
  Puisque 
