...
\begin{prop}
  ...
  $$\forall x\in H,\ \sum_{n=1}^\infty\abs{\ps{e_n,x}}\leqslant ||x||^2.$$
\end{prop}
...
\begin{Proof}{démonstration du théorème de projection}
  À FAIRE
\end{Proof}


\begin{Proof}{démonstration de la formulation variationelle}
  À FAIRE
\end{Proof}
...
\begin{propC}{projection sur un s.e.v. fermé}
  ...
  on a 
  $$u=P_M(x)\Leftrightarrow\begin{cases}
    u\in M\\
    \forall v\in M,\ \ps{x-u,v}=0.
  \end{cases}$$
\end{propC}
