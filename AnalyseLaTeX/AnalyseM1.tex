...
\begin{Proof}
  ...
  $\dagger$ On suppose donc $\dim H=\infty$. $H$ est séparable donc il existe une suite $\ens{g_n}_{n\geqslant 0}$ dense dans $H$, on va suppose que les $(_n)$ sont tous non-nuls. 
